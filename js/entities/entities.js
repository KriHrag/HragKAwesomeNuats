...
game.EnemyCreep = me.Entity.extend({
    init: function(x, y, settings) {
        ...
        //keeps track of when creep last attacked anything
        this.latAttacking = new Date().getTime();
        //keep track of the last time our creep hit anything
        this.lastHit = new Date().getTime();
        this.noow = new Date().getTime();
    ...
    update: function(delta) {
        ...
        me.colliision.check(this, true, this.collideHandler.bind(this), true);
